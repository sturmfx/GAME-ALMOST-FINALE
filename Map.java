...
public class Map
{
    ...
    {
        Map map = new Map(5000, 5000, 500, 500);

        map.walls.add(new Rectangle(600, 600, 200, 400, false, false, false, Color.BLACK));
        map.walls.add(new Rectangle(1000, 200, 200, 400, false, false, false, Color.BLACK));
        map.walls.add(new Rectangle(200, 1400, 800, 400, false, false, false, Color.BLACK));
        map.walls.add(new Rectangle(1200, 1000, 200, 600, false, false, false, Color.BLACK));
        map.walls.add(new Rectangle(1600, 200, 400, 600, false, false, false, Color.BLACK));
        map.walls.add(new Rectangle(2000, 1200, 400, 800, false, false, false, Color.BLACK));
        map.walls.add(new Rectangle(3000, 200, 600, 1400, false, false, false, Color.BLACK));
        map.walls.add(new Rectangle(4200, 1000, 400, 1600, false, false, false, Color.BLACK));
        map.walls.add(new Rectangle(1600, 2400, 1600, 400, false, false, false, Color.BLACK));
        map.walls.add(new Rectangle(800, 2200, 400, 1400, false, false, false, Color.BLACK));
        map.walls.add(new Rectangle(400, 3800, 200, 800, false, false, false, Color.BLACK));
        map.walls.add(new Rectangle(1200, 4000, 400, 400, false, false, false, Color.BLACK));
        map.walls.add(new Rectangle(2000, 3000, 400, 1400, false, false, false, Color.BLACK));
        map.walls.add(new Rectangle(3000, 3400, 1800, 400, false, false, false, Color.BLACK));
        map.walls.add(new Rectangle(3800, 4200, 400, 400, false, false, false, Color.BLACK));
        return map;
    }
}
